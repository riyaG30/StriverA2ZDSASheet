...
public class MinPrioirtyQueue {
	//in min heap all the elements below the nodes should be greater
	public ArrayList<Integer> arr;
	public MinPrioirtyQueue()
	{
		arr=new ArrayList<>();
	}
	public int size()
	...
	public static void main(String[] args) {
		MinPrioirtyQueue mq=new MinPrioirtyQueue();
		mq.add(1);
		mq.add(4);
		mq.add(9);
		mq.add(7);
		...
		while(!mq.isEmpty())
		{
			System.out.println(mq.removeMin());
		}
	}
